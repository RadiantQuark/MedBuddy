...
$query = "SELECT date, medication_name, medication_name, medication_dose, medication_dose, medication_frequency, medication_frequency, prescription_begin, prescription_begin, prescription_end,prescription_end, medication_link,medication_link, medication_warnings,medication_warnings FROM medicine WHERE username='" . $_SESSION['username'] . "'"; //You don't need a ; like you do in SQL
...
while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
                                        ...
                                        echo "<td>" . XSSdisarm($row["medication_name"]) . "</td>";
										echo "<td>" . XSSdisarm($row["medication_dose"]) . "</td>";
										echo "<td>" . XSSdisarm($row["medication_frequency"]) . "</td>";
										echo "<td>" . XSSdisarm($row["prescription_begin"]) . " - " . $row["prescription_end"] . "</td>";
										...
										echo "<td><a href=" . XSSdisarm($row["medication_link"]) . ">" . XSSdisarm($row["medication_link"]) . "</a></td>";
