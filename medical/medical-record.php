...
$query = "SELECT date, location, responsive_doctor, issue_description, diagnosis, prescribed_solution FROM medicalrecords WHERE username='" . $_SESSION['username'] . "'";; //You don't need a ; like you do in SQL
$result = mysqli_query($connection, $query);					
while($row = mysqli_fetch_array($result)){   //Creates a loop to loop through results
										echo "<tbody>";
										echo "<tr>";
                                        echo "<td>" . XSSdisarm($row['date']) . "</td>";
										echo "<td>" . XSSdisarm($row["location"]) . "</td>";
										echo "<td>" . XSSdisarm($row["responsive_doctor"]) . "</td>";
										echo "<td>" . XSSdisarm($row["issue_description"]) . "</td>";
										echo "<td>" . XSSdisarm($row["diagnosis"]) . "</td>";
										echo "<td>" . XSSdisarm($row["prescribed_solution"]) . "</td>";
										echo "</tr>";
										echo "</tbody>";
										}
